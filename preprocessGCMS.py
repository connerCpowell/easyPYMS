...
def main():
    ...
    dirc = sys.argv[1]
    #Where to cut string for downstream naming
    sp = sys.argv[2]
    #Number of points used to describe window length for peak detection
    points = int(sys.argv[3])
    #Number of adjecent scans compared during peak detection
    scans = int(sys.argv[4])
    #Theshold percentage which a peak needs to exceed to be considered real
    percent = int(sys.argv[5])
    #Minimum number of ions required to be considered a real peak
    nin = int(sys.argv[6])
    #Storage directory for .csv files (NIST analysis)
    sdir = sys.argv[7]
    #Storage directory for .expr files (Alignment input)
    sdir2 = sys.argv[8]
